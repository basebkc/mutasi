    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i> Input <span class='fw-300'>Master Dokument</span> 
                <small>
                    Upload file dokument sesuai dokument Sk
                </small>
            </h1>
        </div>
        <div class="row">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <div class="panel-tag">
                                        Jika belum dibuatkan Dokument SK berserta parameternya maka tidak bisa melakukan upload Dokument SK.
                                    </div>
                                    ...
                                    <div class="panel-container show">
                                        ...
                                        {{-- <form action="{{ url('mutasi/master/tambah/store') }}" enctype="multipart/form-data" method="POST"> --}}
                                            @csrf
                                           
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label" for="totalAsset">Dokument SK</label>
                                                        <select class="form-control select2" id="dokumentsk" name="dokumentsk" required>
                                                            <option value="">-- Cari dokument SK --</option>
                                                            @foreach ($data as $item)
                                                                <option value="{{ $item->id }}">{{ $item->nama_sk }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
